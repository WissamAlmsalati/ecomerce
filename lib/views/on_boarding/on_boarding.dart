...
class OnBoarding extends StatelessWidget {
  ...
  child: ClipRRect(
    ...
    child: Image.asset(
      'assets/images/medium-shot-woman-coat-posing.jpg',
      fit: BoxFit.cover,
    ),
  ),
),
                    Column(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            image: const DecorationImage(
                              image: AssetImage('assets/images/medium-shot-boy-posing-with-monochrome-outfit.jpg',), fit: BoxFit.cover,),
                            borderRadius: BorderRadius.circular(140),
                          ),
                        ),
                        const SizedBox(
                        ...
                        Container(
                          ...
                          decoration:  BoxDecoration(
                            image: const DecorationImage(
                              image: AssetImage('assets/images/pretty-woman-coat-looking-camera.jpg',),fit: BoxFit.cover),
                            borderRadius: BorderRadius.circular(140),
                          ),
                        )
                      ],
